...
public class QuestionMaker {
	...
	public static Question makeQuestion(TypeOfQuestion typeOfQuestion, String category, String text, Object... extraParams) {
		...
		case TRUE_FALSE:
			...
			return new TrueFalseQuestion(category, text, (Boolean) extraParams[0]);
		...
		case MULTIPLE_ANSWER:
			...
			return new MultipleChoiceQuestion(category, text, (List<String>) extraParams[0], (List<String>) extraParams[1]);		
		default:
